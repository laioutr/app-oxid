 ...
 */
const matchThumbnail = (thumbnails: ParsedOxidThumbnail[], options: { width?: number; height?: number }) => {
...
/**
 * Nuxt image provider using Oxid thumbnails.
 *
 * The only modifications supported are "width" and "height". The provider tries to find a best-fit image from the available Oxid thumbnails.
 */
